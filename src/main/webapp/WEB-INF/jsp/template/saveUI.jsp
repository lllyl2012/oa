...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="template_%{id==null?'add':'edit'}" namespace="/" theme="simple"  method="post" enctype="multipart/form-data" >
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td>
                        <s:select list="pdList" listKey="key" listValue="key" cssClass="SelectStyle" name="processKey"></s:select>
                          *
						</td>
                    </tr>
                </table>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
				   	<tr>
                        ...
                        <td>
                        <input type="file" name="uploadFile" class="InputStyle" style="width:450px;" /> 
                        </td>
                    </tr>
                </table>
            </div>
