...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<font class="MenuPoint"> &gt; </font>
			<s:a action="forum_show?id=%{forum.id}" namespace="/">
				${forum.name }
			</s:a>
			<font class="MenuPoint"> &gt;&gt; </font>
			${title }
			<span style="margin-left:30px;">
			   <s:a action="topic_addUI?forumId=%{forum.id}">
				<img align="middle" src="${pageContext.request.contextPath}/style/blue/images/button/publishNewTopic.png"/></s:a>
			</span>
		</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						<s:a cssClass="detail" action="reply_addUI?topicId=%{id}">
	...
	<s:form action="reply_add" namespace="/" theme="simple">
...
<s:form action="topic_show" namespace="/" id="pageForm">
