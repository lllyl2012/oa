...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="topic_add" namespace="/" cssClass="margin: 0; padding: 0;" theme="simple">
	<div id="PageHead"></div>
	<center>
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				...
				<tr height="240">
					...
					<td class="InputAreaBg"><div class="InputContent"><textarea name="content" id="editor1"></textarea></div></td>
				</tr>
				<tr height="30">
