...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="department_%{id==null?'add':'edit'}" namespace="/" theme="simple">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                        	<s:select name="parentId" cssClass="SelectStyle" list="#departmentList" listKey="id" listValue="name" headerKey="" headerValue="==请选择部分==">
                        		
                        	
                        	</s:select>
<!--                         listKey对应value listValue对应文本  与实体类保证一致 headerKey第一个 headerValue对应请选择部门 -->
<%--                         <s:select name="parentId" list="departmentList" listKey="id" listValue="name" headerKey="" headerValue="请选择部门"> --%>
<%--                         </s:select> --%>
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
