...
<div id="QueryArea">
	<div style="height: 30px">
		<s:form action="flow_myApplicationList" id="pageForm" namespace="/" theme="simple">
		<table border=0 cellspacing=3 cellpadding=5>
			<tr>
				<td>按条件查询：</td>
				<td>
				   <s:select cssClass="SelectStyle" list="templateList" name="templateId" listKey="id" listValue="name"headerKey="" headerValue="查看全部状态"></s:select>
				</td>
				<td>
				   <s:select cssClass="SelectStyle" list="%{{'审批中','未通过','已通过'}}" name="status" headerKey="" headerValue="查看全部状态"></s:select>
				</td>
