...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="flow_submit" namespace="/" method="post" theme="simple" enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td>
						  <s:a action="template_download?id=%{templateId}" cssClass="text-decoration: underline">[点击下载文档模板文件]</s:a>
						</td>
					</tr>
                </table>
            </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="file" name="uploadFile" class="InputStyle" style="width:450px;" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
